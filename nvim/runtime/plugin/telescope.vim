...
nnoremap <silent> <leader>fj <cmd>lua require('derek/telescope').storefront_renderer()<cr>
nnoremap <silent> <leader>fr <cmd>lua require('derek/telescope').sonic_framework()<cr>
